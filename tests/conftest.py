...
def app(tmp_path):
    ...
    config = {
        ...
        "AGENT_REPORT_AI_PROVIDER": "openai",
        "AGENT_REPORT_AI_MODEL": "test-report-model",
        "AGENT_REPORT_AI_API_KEY": "test-report-key",
        "AGENT_REPORT_AI_BASE_URL": "",
        "AGENT_REPORT_AI_TIMEOUT_SECONDS": 10,
        "AGENT_MAIN_AI_PROVIDER": "openai",
        "AGENT_MAIN_AI_MODEL": "test-main-model",
        "AGENT_MAIN_AI_API_KEY": "test-main-key",
        "AGENT_MAIN_AI_BASE_URL": "",
        "AGENT_MAIN_AI_TIMEOUT_SECONDS": 10,
        "AGENT_SEARCH_AI_PROVIDER": "openai",
        "AGENT_SEARCH_AI_MODEL": "test-search-model",
        "AGENT_SEARCH_AI_API_KEY": "test-search-key",
        "AGENT_SEARCH_AI_BASE_URL": "",
        "AGENT_SEARCH_AI_TIMEOUT_SECONDS": 10,
        "AGENT_ANALYSIS_AI_PROVIDER": "openai",
        "AGENT_ANALYSIS_AI_MODEL": "test-analysis-model",
        "AGENT_ANALYSIS_AI_API_KEY": "test-analysis-key",
        "AGENT_ANALYSIS_AI_BASE_URL": "",
        "AGENT_ANALYSIS_AI_TIMEOUT_SECONDS": 10,
        "AGENT_DISPLAY_AI_PROVIDER": "openai",
        "AGENT_DISPLAY_AI_MODEL": "test-display-model",
        "AGENT_DISPLAY_AI_API_KEY": "test-display-key",
        "AGENT_DISPLAY_AI_BASE_URL": "",
        "AGENT_DISPLAY_AI_TIMEOUT_SECONDS": 10,

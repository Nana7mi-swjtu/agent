...
class Config:
    ...
    AGENT_REPORT_AI_PROVIDER = os.getenv("AGENT_REPORT_AI_PROVIDER", "").strip().lower()
    AGENT_REPORT_AI_MODEL = os.getenv("AGENT_REPORT_AI_MODEL", "").strip()
    AGENT_REPORT_AI_API_KEY = os.getenv("AGENT_REPORT_AI_API_KEY", "").strip()
    AGENT_REPORT_AI_BASE_URL = os.getenv("AGENT_REPORT_AI_BASE_URL", "").strip()
    AGENT_REPORT_AI_TIMEOUT_SECONDS = int(os.getenv("AGENT_REPORT_AI_TIMEOUT_SECONDS", str(AI_TIMEOUT_SECONDS)))
    ...
    AGENT_ANALYSIS_AI_PROVIDER = os.getenv("AGENT_ANALYSIS_AI_PROVIDER", "").strip().lower()
    AGENT_ANALYSIS_AI_MODEL = os.getenv("AGENT_ANALYSIS_AI_MODEL", "").strip()
    AGENT_ANALYSIS_AI_API_KEY = os.getenv("AGENT_ANALYSIS_AI_API_KEY", "").strip()
    AGENT_ANALYSIS_AI_BASE_URL = os.getenv("AGENT_ANALYSIS_AI_BASE_URL", "").strip()
    AGENT_ANALYSIS_AI_TIMEOUT_SECONDS = int(os.getenv("AGENT_ANALYSIS_AI_TIMEOUT_SECONDS", str(AI_TIMEOUT_SECONDS)))
    AGENT_DISPLAY_AI_PROVIDER = os.getenv("AGENT_DISPLAY_AI_PROVIDER", "").strip().lower()
    AGENT_DISPLAY_AI_MODEL = os.getenv("AGENT_DISPLAY_AI_MODEL", "").strip()
    AGENT_DISPLAY_AI_API_KEY = os.getenv("AGENT_DISPLAY_AI_API_KEY", "").strip()
    AGENT_DISPLAY_AI_BASE_URL = os.getenv("AGENT_DISPLAY_AI_BASE_URL", "").strip()
    AGENT_DISPLAY_AI_TIMEOUT_SECONDS = int(os.getenv("AGENT_DISPLAY_AI_TIMEOUT_SECONDS", str(AI_TIMEOUT_SECONDS)))
    ...
    AGENT_CHAT_JOBS_ENABLED = _bool_env("AGENT_CHAT_JOBS_ENABLED", True)
    AGENT_CHAT_JOB_WORKERS = int(os.getenv("AGENT_CHAT_JOB_WORKERS", "2"))
    AGENT_CHAT_JOBS_SYNC_EXECUTION = _bool_env("AGENT_CHAT_JOBS_SYNC_EXECUTION", False)
